...
ttsname=("name.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
tts.save(ttsname)
...
ttsname=("hello.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
tts.save(ttsname)
...
ttsname=("hello.mp3") #Example: path -> C:\User\RAX> just change with your desktop directory. Don't use my directory.
tts.save(ttsname)
...
if text == '1' or text == 'One' or text == 'one':
    ...
    mail.login('rakshitkashyap11121998@gmail.com','rakshitkashyap') #login part
    mail.sendmail('rakshitkashyap11121998@gmail.com','amanansari21@gmail.com',msg) #send part
    print ("Congrates! Your mail has send. ")
    tts = gTTS(text="Congrates! Your mail has send. ", lang='en')
    ttsname=("send.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
    tts.save(ttsname)
    music = pyglet.media.load(ttsname, streaming = False)
    music.play()
    time.sleep(music.duration)
...
if text == '2' or text == 'tu' or text == 'two' or text == 'Tu' or text == 'to' or text == 'To' :
    ...
    unm = ('rakshitkashyap11121998@gmail.com')  #username
    psw = ('rakshitkashyap')  #password
    ...
    ttsname=("total.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
    tts.save(ttsname)
    music = pyglet.media.load(ttsname, streaming = False)
    music.play()
    time.sleep(music.duration)
    ...
    ttsname=("unseen.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
    tts.save(ttsname)
    music = pyglet.media.load(ttsname, streaming = False)
    music.play()
    time.sleep(music.duration)
    ...
    ttsname=("mail.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
    tts.save(ttsname)
    music = pyglet.media.load(ttsname, streaming = False)
    music.play()
    time.sleep(music.duration)
    ...
    ttsname=("body.mp3") #Example: path -> C:\Users\RAX> just change with your desktop directory. Don't use my directory.
    tts.save(ttsname)
    music = pyglet.media.load(ttsname, streaming = False)
    music.play()
    time.sleep(music.duration)
